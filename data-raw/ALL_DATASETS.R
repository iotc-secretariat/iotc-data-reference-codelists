...
VESSEL_MEASUREMENT_TYPES   <- fishery_domain("VESSEL_MEASUREMENT_TYPES")
...
HOOK_AND_TERMINAL_DEVICES  <- fishery_domain("HOOK_AND_TERMINAL_DEVICES")
NET_MATERIAL_TYPES         <- fishery_domain("NET_MATERIAL_TYPES")
...
SPECIES_CATEGORIES <- biology_domain("SPECIES_CATEGORIES")
SPECIES_GROUPS     <- biology_domain("SPECIES_GROUPS")
...
BIOLOGICAL_MATERIALS <- biology_domain("BIOLOGICAL_MATERIALS")
...
RECOMMENDED_MEASUREMENTS <- biology_domain("RECOMMENDED_MEASUREMENTS")
...
use_data(BIOLOGICAL_MATERIALS, overwrite = TRUE)  #v2
...
use_data(RECOMMENDED_MEASUREMENTS, overwrite = TRUE)
...
LEGACY_MEASURE_TYPES_IOTDB <- query(DB_IOTDB(), "SELECT * FROM meta.MEASURE_TYPES") # sane as LEGACY_MEASUREMENT_TYPES with sort column
...
## Extract the data from IOTC database ####
COUNTRY_CURRRENCIES <- socio_economics_domain("V_COUNTRY_CURRENCIES")
...
## Save package data as rda in data folder ####
use_data(COUNTRY_CURRRENCIES, overwrite = TRUE)
