...
| ROS_references.CL_BAIT_CONDITIONS                  | refs_biological.BAIT_CONDITIONS                           | ros_ll. baits_and_conditions                              | bait_condition_id                   | bait_condition_code                   |
...
| ROS_references.CL_COUNTRIES                        | refs_admin.COUNTRIES                                      | ros_references. cl_ports                                  | country_id                          | country_code                          |
...
| Ros_references.CL_HULL_MATERIALS                   | refs_fishery.HULL_MATERIAL_TYPES                          | ros_ll. ll_catch_details                                  | fates_id                            | fates_code                            |
...
| ROS_references.CL_FISH_STORAGE_TYPES               | refs_fishery.FISH_STORAGE_TYPES                           | ros_references. vessel_attributes_fish_storage_type       | fish_storage_type_id                | fish_storage_type_code                |
| ROS_references.CL_FLOAT_TYPES                      | refs_fishery.FLOAT_TYPES                                  | ros_references.gillnet_configuration                      | float_type_id                       | float_type_code                       |
...
| Ros_references.CL_GEAR_TYPES                       | refs_fishery_config.GEARS                                 | ros_references.vessel_identification                      | main_fishing_gear_id                | main_fishing_gear_code                |
| Ros_references.CL_GILLNET_MATERIAL_TYPES           | refs_fishery.GILLNET_MATERIAL_TYPES                       | ros_references.gillnet_configuration                      | gillnet_material_type_id            | gillnet_material_type_code            |
...
| ROS_references.CL_HULL_MATERIALS                   | refs_fishery.HULL_MATERIAL_TYPES                          | ros_common.lures_or_jiggers_by_type                       | hull_material_id                    | hull_material_code                    |
...
| ROS_references.CL_TAG_TYPES                        | refs_biological.TAG_TYPES                                 | ros_pl.pl_catch_details                                   | tag_type_id                         | tag_type_code                         |
| ROS_references.CL_TAG_TYPES                        | refs_biological.TAG_TYPES                                 | ros_ps.ps_catch_details                                   | tag_type_id                         | tag_type_code                         |
| ROS_references.CL_TAG_TYPES                        | refs_biological.TAG_TYPES                                 | ros_gn.gn_catch_details                                   | tag_type_id                         | tag_type_code                         |
| ROS_references.CL_TAG_TYPES                        | refs_biological.TAG_TYPES                                 | ros_ll.ll_catch_details                                   | tag_type_id                         | tag_type_code                         |
